...
set_max_delay -datapath_only -from [get_clocks sys_clk_pin] -to [get_clocks -of_objects [get_pins vga/clock_pix_inst/MMCME2_BASE_inst/CLKOUT1]] 10.0
...
##Buttons
#set_property -dict {PACKAGE_PIN C12 IOSTANDARD LVCMOS33} [get_ports CPU_RESETN ]; #Active Low Button!
set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports BUTT1]
set_property -dict {PACKAGE_PIN M18 IOSTANDARD LVCMOS33} [get_ports LEVER]
...
##Pmod Headers
##Pmod Header JA
#set_property -dict { PACKAGE_PIN C17   IOSTANDARD LVCMOS33 } [get_ports { STMPE610_CS_N }]; #IO_L20N_T3_A19_15 Sch=ja[1]
...
#set_property -dict { PACKAGE_PIN H14   IOSTANDARD LVCMOS33 } [get_ports { JB[5] }]; #IO_L15P_T2_DQS_15 Sch=jb[4]
